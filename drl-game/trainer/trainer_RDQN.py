...
def main(cfg_path: str):
    ...
    run_name = cfg.get("run_name", "rainbow_run")
    ...
    hp = cfg.get("rainbow", {})  # allow `rainbow:` section in YAML
...
if __name__ == "__main__":
    ...
    parser.add_argument("config", nargs="?", default="drl-game/configs/breakout_rainbow.yaml",
