...
import private_eye from '@/images/private_eye.gif';
...
import skiing from '@/images/skiing.gif';
...
import turmoil from '@/images/turmoil.gif';
...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    actions: [
      { key: '1', action: 0, label: 'NOOP (1)' },
      { key: '2', action: 1, label: 'FIRE (2)' },
      { key: 'ArrowLeft', action: 3, label: 'LEFT (←)' },
      { key: 'ArrowRight', action: 2, label: 'RIGHT (→)' },
  ...
  },
  {
    ...
    actions: [
      ...
      { key: 'ArrowUp', action: 1, label: 'UP (↑)' },
      { action: 5, label: 'UPRIGHT' },
      { key: 'ArrowLeft', action: 3, label: 'LEFT (←)' },
      { key: '1', action: 0, label: 'NOOP (1)' },
      { key: 'ArrowRight', action: 2, label: 'RIGHT (→)' },
      { action: 8, label: 'DOWNLEFT' },
      { key: 'ArrowDown', action: 4, label: 'DOWN (↓)' },
  ...
  },
  {
    ...
    image: backgammon,
    actions: [
      { key: 'ArrowLeft', action: 2, label: 'LEFT (←)' },
      { key: '2', action: 0, label: 'FIRE (2)' },
      { key: 'ArrowRight', action: 1, label: 'RIGHT (→)' },
    ],
  },
  {
  ...
  },
  {
    ...
    actions: [
      { key: 'ArrowUp', action: 2, label: 'UP (↑)' },
      { key: '1', action: 0, label: 'NOOP (1)' },
      { key: 'ArrowDown', action: 3, label: 'DOWN (↓)' },
      { key: '2', action: 1, label: 'FIRE (2)' },
    ],
    twoActionColumns: true,
  },
  ...
  },
  {
    ...
    actions: [
      { key: 'ArrowUp', action: 1, label: 'UP (↑)' },
      { key: '1', action: 0, label: 'NOOP (1)' },
      { key: 'ArrowDown', action: 2, label: 'DOWN (↓)' },
    ],
    twoActionColumns: true,
  },
  {
